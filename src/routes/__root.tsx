...
import { registerAppTools } from "../lib/webmcp-live";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Auto WebMCP by Satsuma.ai scans your website, generates structured tools, and activates them at the edge through Cloudflare, Akamai, Fastly, HUMAN, or DataDome." },
      ...
      { property: "og:description", content: "Auto WebMCP by Satsuma.ai scans your website, generates structured tools, and activates them at the edge through Cloudflare, Akamai, Fastly, HUMAN, or DataDome." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Auto WebMCP by Satsuma.ai — Make your website agent-ready in 60 seconds" },
      { name: "twitter:description", content: "Auto WebMCP by Satsuma.ai scans your website, generates structured tools, and activates them at the edge through Cloudflare, Akamai, Fastly, HUMAN, or DataDome." },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/96571b0f-3017-46eb-a103-35b8d1080871/satsuma-logo.png" },
    ],
  }),
